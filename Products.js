...
const products = [
  ...
  new Product(
    2,
    'Fresh Strawberries - Per Package',
  ...
  new Product(
    4,
    'Organic Cantaloupe Melon - Fresh Cut',
  ...
  new Product(
    6,
    'California Margherita Pizza - Crispy Thin',
  ...
  new Product(
    7,
    '100% Apple Juice – 64fl oz Bottle',
